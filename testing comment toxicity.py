...
loaded=CountVectorizer(decode_error='replace',vocabulary=pickle.load(open(r"D:\smartintern\Commet-Toxicity-Multi-Class-Classification-main\word_features.pkl",'rb')))
