...
train_df = pd.read_csv(r"D:\smartintern\Data\train.csv")
test_df = pd.read_csv(r"D:\smartintern\Data\test.csv")
...
pickle.dump(word_vect.vocabulary_,open("D:\smartintern\Commet-Toxicity-Multi-Class-Classification-main\word_features.pkl",'wb'))
...
submission_binary = pd.read_csv(r"D:\smartintern\Data\sample_submission.csv")

mapper = {}
for label in cols_target:
    mapper[label] = logreg
    filename = str(label+'_model.pkl')
    print(filename)
...
submission_binary.to_csv(r"D:\smartintern\Data\submission_binary (1).csv",index=False)
